...
public class CrawlingList {
    ...
    public void saveList(){
        ...
        try{
            ...
            FileOutputStream fo= new FileOutputStream("c:\\CrawlingInfo\\links_to_crawl.txt");
            ...
            out.flush();
            out.close();
            fo= new FileOutputStream("c:\\CrawlingInfo\\crawled_list.txt");
           ...
           // out= new BufferedWriter(new FileWriter("c:\\CrawlingInfo\\crawled_list.txt"));
            ...
            out.flush();
            out.close();
             fo= new FileOutputStream("c:\\CrawlingInfo\\error_pages_list.txt");
           osw = new OutputStreamWriter(fo,"UTF8");//
           out= new BufferedWriter(osw);
