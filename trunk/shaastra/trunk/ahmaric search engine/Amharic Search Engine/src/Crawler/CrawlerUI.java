...
public class CrawlerUI extends javax.swing.JFrame {
    ...
    private StringBuffer buffer; /* for storing page being downloaded */
    private CrawlingList links_queue; /* FIFO queue for url to be crawled*/
    private HtmlParser parser; /* For parsing the html page downloaded */
    ...
    public void readLinkListFiles() {
        try{
        FileInputStream fr= new FileInputStream("C:\\Users\\vijay\\Documents\\sanskrit search engine\\sanskrit search engine\\CrawlingInfo\\links_to_crawl.txt");
     ...
     public void restartCrawling() {
        try{
       // BufferedReader in= new BufferedReader(new FileReader("c:\\CrawlingInfo\\starting_links_to_crawl.txt"));
        FileInputStream fr= new FileInputStream("C:\\Users\\vijay\\Documents\\sanskrit search engine\\sanskrit search engine\\CrawlingInfo\\starting_links_to_crawl.txt");
        InputStreamReader isr = new InputStreamReader(fr,"UTF8");//
        BufferedReader in= new BufferedReader(isr);
        String link;
        link_list.clear();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(68, 68, 68)
                        .add(jLabel2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 448, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
            ...
            .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel2Layout.createSequentialGroup()
                        ...
                        .add(29, 29, 29)
                        .add(jButton8, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 167, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jLabel4)
                    .add(jLabel3)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                .add(33, 33, 33)
                .add(jScrollPane4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 612, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                .add(38, 38, 38)
                .add(jScrollPane4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 408, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
...
// TODO add your handling code here:
    ...
    public class Crawler implements Runnable{
     ...
     public Crawler() {
         ...
         /*
         * setting the system properties to allow proxy server, 
         * otherwise we can't get the web pages thru firewall.
         */
        
	 Properties prop = System.getProperties();
         prop.put("proxySet", "true"); // for HTTP
	 prop.put("proxyHost", "hproxy.iitm.ac.in");
	 prop.put("proxyPort", "3128");
	 prop.put("ftpProxySet", "true"); // for FTP
	 prop.put("ftpProxyHost", "hproxy.iitm.ac.in");
	 prop.put("ftpProxyPort", "3128");
     ...
     public void  run(){
        ...
        String size;/* The pages may have three types of encoding
                                           * UTF-8, Unicode, ISO
                                          */
       // links_queue.addLink("http://www.yahoo.com");       
        jTextArea1.append("Crawler started:"+(new Date()).toString()+ "\n");
        while((strUrlDoc=links_queue.getLink())!=null && !stop_thread){ 
          temp_charset="UTF8";//ISO-8859-1";  
          jTextArea1.append(strUrlDoc+"\n");
        try
        {
            buffer= new StringBuffer();
           // jTextArea1.append("Crawling document:\n "+ strUrlDoc+"\n");
        ...
        if(!isModified(strUrlDoc,date_modified))
            {
                ...
                if(charset.startsWith("UTF"))
                    links_queue.addLink(parser.parseUTF(buffer.toString(),strUrlDoc,urlToCrawl.getHost(),date_modified,size));
                else
                    links_queue.addLink(parser.parse(buffer.toString(),strUrlDoc,urlToCrawl.getHost(),date_modified,size));
        
              // FileOutputStream fos = new FileOutputStream("c:\\downloads\\"+System.currentTimeMillis()+".htm");
               //Writer out = new OutputStreamWriter(fos,charset);
              // out.write(buffer.toString());
             //  out.close();
            }
            
           // jTextArea1.append("content follows....."+HtmlParser.readme);
