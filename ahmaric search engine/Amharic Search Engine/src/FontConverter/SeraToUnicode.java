 ...
 * SeratoUnicode.java
 *
 * SeratoUnicode implements font encoding conversion from the Visual Ge'ez 2
...
/**
 * Sera2toUnicode class accepts a string in Sera encoding and returns an equivalent 
 * VG Unicode string
 */
import java.io.*;
import java.util.*;
public class SeraToUnicode {
