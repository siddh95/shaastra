/**
 * ALEXEthiotoUnicode.java
 *
 * ALEXEthiotoUnicode implements font encoding conversion from the ALEX Ethiopian
...
/**
 * ALEXEthiotoUnicode class accepts a string in VG2 encoding and returns an equivalent 
 * VG Unicode string
 */
import java.io.*;
import java.util.*;
public class ALEXEthiotoUnicode {
