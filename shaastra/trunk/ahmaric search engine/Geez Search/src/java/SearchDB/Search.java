...
public class Search extends HttpServlet {
    ...
    throws ServletException, IOException{
      ...
      out.println("<center><img src=\"images/Geezsmall.gif\" alt=\"logo\"/><P>");  
      ...
      out.println("</td>");
        ...
        TextFragmenter fragmented_text= new TextFragmenter(search_result.getUserQuery());
         ...
         for (int i=(page_no-1)*10; i<(page_no-1)*10+10; i++) {
            ...
            if(search_result.getUrl(i)==null||search_result.getUrl(i)=="") continue;
            foundany=true;
         ...
         for(int i= 1;foundany&&(i<=search_result.totlaDocmentsFound()/10+1);i++){
